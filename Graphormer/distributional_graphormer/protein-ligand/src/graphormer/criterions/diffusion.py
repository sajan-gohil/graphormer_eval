...
class DiffusionLoss(BaseCriterion):
    ...
    def reduce_metrics(logging_outputs) -> None:
        ...
        metrics = {
            ...
            "rmsd": rmsd_sum / sample_size if rmsd_sum > 0 else 0,
            "rmsd_lig": rmsd_lig_sum / sample_size if rmsd_lig_sum > 0 else 0,
            "rmsd_pro": rmsd_pro_sum / sample_size if rmsd_pro_sum > 0 else 0,
        }
        return metrics
