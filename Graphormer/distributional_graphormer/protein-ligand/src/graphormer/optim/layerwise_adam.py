...
@dataclass
class LayerwiseAdamConfig(BaseConfig):
...
class LayerwiseAdam(torch.optim.Optimizer):
    def __init__(self, cfg: LayerwiseAdamConfig, params):
        self.cfg = cfg
    ...
    def backward(self, loss):
        """Computes the gradient of loss with respect to parameters."""
        loss.backward()
    ...
    def step(self, closure=None):
        ...
        for group in self.param_groups:
            for p in group["params"]:
                ...
                step_size = group["lr"] * p.lr_scale / bias_correction1
