...
python3 main_three_staged.py --backbone vanilla_gt \
    --stage "1,2,3" \
    --generator gred_layers --hidden_dim 512 --num_transformer_layers 1 \
    --num_layers 1 --no-use_lap_pe \
    --s1_lr 3e-5 --s1_patience 20 --s1_max_epochs 300 \
    --num_proxies 64  \
    --s2_lr 3e-5 --s2_max_epochs 1000 --s2_patience 100  --s2_grad_clip 5.0  \
    --s3_lr_transformer 1e-5 --s3_lr_gen 1e-5 --s3_weight_decay 1e-4 \
    --s3_grad_clip 5 --s3_max_epochs 1000 --s3_patience 100 \
    --diversity_weight 0.0 --novelty_alpha 0.0 \
    --gen_hidden_dim 128 --gen_num_layers 4 --gen_dropout 0.1 \
    --denoiser_layers 2 \
    --save_dir checkpoints_ts_gred_vanilla \
    --batch_size 64 \
